...
axarr[0,0].plot([xmin, xmax], [0.5/pi/xmin, 0.5/pi/xmax], linestyle=':', color='blue')
...
#axarr[2,0].scatter(x0, u0, color='black', marker='.', s=1.0)
#axarr[2,0].plot(r, u, color="red", label='PPM solution')
...
axarr[2,0].scatter(x0, entropy0, color='black', marker='.', s=1.0)
