...
gradhsphsim_unequal.SetParam('Nlattice1[0]',Nright)
gradhsphsim_unequal.SetParam('Nlattice2[0]',Nright)
setupsim()
run()
...
mfvsim_unequal.SetParam('Nlattice1[0]',Nright)
mfvsim_unequal.SetParam('Nlattice2[0]',Nright)
setupsim()
run()
...
mfmsim_unequal.SetParam('Nlattice1[0]',Nright)
mfmsim_unequal.SetParam('Nlattice2[0]',Nright)
setupsim()
run()
...
mfmsim_unequal_hllc.SetParam('Nlattice1[0]',Nright)
mfmsim_unequal_hllc.SetParam('Nlattice2[0]',Nright)
setupsim()
run()
...
fig, axarr = plt.subplots(3, 3, sharex='col', sharey='row', figsize=(13,8))
...
axarr[0,0].scatter(x0, rho0, color='black', marker='+', label='Gradh-SPH, equal-mass')
axarr[0,0].scatter(x1, rho1, marker='o', facecolors='none', edgecolors='blue', label='Gradh-SPH, unequal-mass')
...
axarr[1,0].scatter(x0, vx0, color='black', marker='+')
axarr[1,0].scatter(x1, vx1, marker='o', facecolors='none', edgecolors='blue')
...
axarr[2,0].scatter(x0, u0, color='black', marker='+')
axarr[2,0].scatter(x1, u1, marker='o', facecolors='none', edgecolors='blue')
...
axarr[0,1].scatter(x2, rho2, color='black', marker='+', label='MFV, equal-mass')
axarr[0,1].scatter(x3, rho3, marker='o', facecolors='none', edgecolors='blue', label='MFV, unequal-mass')
axarr[0,1].legend(fontsize=10)
axarr[1,1].set_ylim([vxmin, vxmax])
axarr[1,1].plot(vxdata.x_data, vxdata.y_data, linestyle='-', color="red")
axarr[1,1].scatter(x2, vx2, color='black', marker='+')
axarr[1,1].scatter(x3, vx3, marker='o', facecolors='none', edgecolors='blue')
axarr[2,1].set_xlabel(r"$x$")
axarr[2,1].set_ylim([umin, umax])
axarr[2,1].plot(udata.x_data, udata.y_data, linestyle='-', color="red")
axarr[2,1].scatter(x2, u2, color='black', marker='+')
axarr[2,1].scatter(x3, u3, marker='o', facecolors='none', edgecolors='blue')
...
axarr[0,2].scatter(x4, rho4, color='black', marker='+', label='MFM, equal-mass')
axarr[0,2].scatter(x5, rho5, marker='o', facecolors='none', edgecolors='blue', label='MFM, unequal-mass')
axarr[0,2].legend(fontsize=10)
axarr[1,2].set_ylim([vxmin, vxmax])
axarr[1,2].plot(vxdata.x_data, vxdata.y_data, linestyle='-', color="red")
axarr[1,2].scatter(x4, vx4, color='black', marker='+')
axarr[1,2].scatter(x5, vx5, marker='o', facecolors='none', edgecolors='blue')
axarr[2,2].set_xlabel(r"$x$")
axarr[2,2].set_ylim([umin, umax])
axarr[2,2].plot(udata.x_data, udata.y_data, linestyle='-', color="red")
axarr[2,2].scatter(x4, u4, color='black', marker='+')
axarr[2,2].scatter(x5, u5, marker='o', facecolors='none', edgecolors='blue')
...
#axarr[0,3].scatter(x6, rho6, color='black', marker='+', label='MFM-HLLC, equal-mass')
#axarr[0,3].scatter(x7, rho7, marker='o', facecolors='none', edgecolors='blue', label='MFM-HLLC, unequal-mass')
#axarr[0,3].legend(fontsize=10)
#axarr[1,3].set_ylim([vxmin, vxmax])
#axarr[1,3].plot(vxdata.x_data, vxdata.y_data, linestyle='-', color="red")
#axarr[1,3].scatter(x6, vx6, color='black', marker='+')
#axarr[1,3].scatter(x7, vx7, marker='o', facecolors='none', edgecolors='blue')
#axarr[2,3].set_xlabel(r"$x$")
#axarr[2,3].set_ylim([umin, umax])
#axarr[2,3].plot(udata.x_data, udata.y_data, linestyle='-', color="red")
#axarr[2,3].scatter(x6, u6, color='black', marker='+')
#axarr[2,3].scatter(x7, u7, marker='o', facecolors='none', edgecolors='blue')
