...
//=================================================================================================
template <int ndim>
RtiIc<ndim>::RtiIc(Simulation<ndim>* _sim, Hydrodynamics<ndim>* _hydro, FLOAT _invndim) :
...
template class RtiIc<1>;
template class RtiIc<2>;
template class RtiIc<3>;
