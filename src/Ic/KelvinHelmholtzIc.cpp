...
//=================================================================================================
template <int ndim>
void KelvinHelmholtzIc<ndim>::Generate(void)
{
  ...
  if (ndim == 2) {
    ...
    debug2("[KelvinHelmholtzIc::Generate]");
...
template class KelvinHelmholtzIc<1>;
template class KelvinHelmholtzIc<2>;
template class KelvinHelmholtzIc<3>;
