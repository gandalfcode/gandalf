...
struct StateVector {
  ...
  PrimitiveVariables Wprim;
  ConservedVariables Ucons;
...
protected:
 ...
 private:
  FLOAT SoundSpeed(FLOAT density, FLOAT internal_energy);
 public:
