...
void MfvRungeKuttaSimulation<ndim>::MainLoop(void)
{
  ...
  // Compute the start of step fluxes
  // ----------------------------------------------------------------------------------------------
#ifdef MPI_PARALLEL
  ...
  mfvneib->SearchBoundaryGhostParticles(0, simbox, mfv);
  ...
  // Compute the end of step fluxes / forces
  // ----------------------------------------------------------------------------------------------
  ...
  // Calculate all matrices and gradients
