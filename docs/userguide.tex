...
barotropic2  & = Similar to barotropic, but using discrete power laws rather than smmoth change
\end{tabular}
...
treemc  &= Monte-Carlo radiation transport using a kd-tree
\end{tabular}
